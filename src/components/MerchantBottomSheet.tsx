          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-green-500 hover:bg-tilkapp-orange text-white rounded-lg font-semibold transition-colors shadow-md"
              >
