          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold transition-colors shadow-md"
              >
          ...
          <div className="space-y-3">
            {offers.map((offer) => (
              <div
                ...
                className="bg-white rounded-lg border border-gray-200 hover:border-tilkapp-blue hover:shadow-md transition-all cursor-pointer overflow-hidden"
              >
                <div className="flex">
                  {/* Image */}
                  {offer.image_url && (
