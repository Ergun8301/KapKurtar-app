        ...
        >
          ...
          <div className="p-4 md:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="flex items-baseline gap-3 bg-orange-50 rounded-lg p-4 mb-4">
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-lg font-bold text-lg shadow-lg transition-all ${
                    isReserving || (offer.quantity && offer.quantity <= 0)
                      ...
                      : 'bg-tilkapp-orange hover:bg-orange-600 text-white hover:shadow-xl'
                  }`}
                >
                  {isReserving ? (
          ...
          {loadingOtherOffers && (
            <div className="border-t border-gray-200 px-6 md:px-8 py-6 bg-gray-50 text-center">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-tilkapp-orange mx-auto"></div>
          ...
          >
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-tilkapp-orange hover:bg-orange-600 text-white rounded-lg font-semibold transition-colors shadow-md"
              >
                Se connecter
              </button>
              <button
