      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="text-center relative">
              {/* Step Number */}
              <div className="absolute -top-4 -left-4 bg-[#00615F] text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg z-10">
                {step.step}
              </div>
              
              {/* Card */}
              <div className="bg-gray-50 rounded-xl p-8 hover:bg-gray-100 transition-colors duration-300 h-full">
                <div className="bg-[#F3EACE] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <step.icon className="w-8 h-8 text-[#00615F]" />
                </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="bg-[#00615F] text-white px-8 py-3 rounded-lg font-medium hover:bg-[#2DD4BF] transition-colors duration-300 inline-block"
          >
