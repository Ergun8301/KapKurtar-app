      ...
      <div ref={bellRef} className="relative select-none">
        ...
        {open && (
          <div className="absolute right-0 mt-2 w-96 bg-white rounded-xl shadow-2xl border border-gray-200 z-[9999] overflow-hidden">
            <div className="flex justify-between items-center px-4 py-3 border-b border-gray-100 bg-[#F7F2E7]">
                ...
                notifications.map((n) => (
                  <div
                    ...
                    className={`px-4 py-3 cursor-pointer border-b border-gray-100 last:border-b-0 transition-all hover:bg-gray-50 ${
                      !n.is_read
                        ? `bg-[#F7F2E7] border-l-4 ${getNotificationBorderColor(n.type)}`
                        : "bg-white border-l-4 border-l-transparent"
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#00A690] to-[#00615F] flex items-center justify-center text-lg shadow-sm">
