        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/offers" className="text-gray-300 hover:text-blue-400 transition-colors">Explore Offers</a></li>
              <li><a href="/merchants" className="text-gray-300 hover:text-blue-400 transition-colors">For Merchants</a></li>
              <li><a href="/download" className="text-gray-300 hover:text-blue-400 transition-colors">Download App</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="mt-6 pt-4 border-t border-gray-700">
                <p className="text-blue-400 font-medium mb-3">Get notified instantly</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="/privacy" className="text-gray-300 hover:text-blue-400 text-sm transition-colors">
                Privacy Policy
              </a>
              <a href="/terms" className="text-gray-300 hover:text-blue-400 text-sm transition-colors">
                Terms of Service
              </a>
              <a href="/cookies" className="text-gray-300 hover:text-blue-400 text-sm transition-colors">
                Cookie Policy
              </a>
            </div>
          </div>
