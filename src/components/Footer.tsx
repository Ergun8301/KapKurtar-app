...
<div className="max-w-7xl mx-auto px-4 py-12">
  <img 
    src="https://zhabjdyzawffsmvziojl.supabase.co/storage/v1/object/public/logos/KK%20fond%20vert%20(1).png" 
    alt="KapKurtar" 
  ...
  />
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          {/* Colonne centre - Boutons téléchargement */}
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-[#F3EACE] hover:text-[#2DD4BF] transition-colors duration-300 text-sm inline-flex items-center gap-2"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex justify-center space-x-6">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[#F3EACE] hover:text-[#2DD4BF] transition-colors duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#F3EACE] hover:text-[#2DD4BF] transition-colors duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-[#F3EACE] hover:text-[#2DD4BF] transition-colors duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
