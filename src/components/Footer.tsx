      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-[#F7F2E7] text-sm leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="mt-6 space-y-3">
                <p className="text-sm font-semibold text-white mb-2">Uygulamayı İndirin</p>

                {/* Google Play - Disabled */}
                <button
                  disabled
                  className="flex items-center gap-2 bg-white/10 border border-white/30 text-white px-4 py-2 rounded-lg w-full opacity-60 cursor-not-allowed"
                  title="Çok yakında!"
                >
      ...
      <div className="border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[#F7F2E7] text-sm">
