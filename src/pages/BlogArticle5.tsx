    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">
            <BarChart3 className="inline w-6 h-6 mr-2 text-[#00615F]" />
          ...
          <div className="bg-white border-2 border-[#00615F] rounded-lg p-6 my-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">
            <Users className="inline w-6 h-6 mr-2 text-[#00615F]" />
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-4">
            <Smartphone className="inline w-6 h-6 mr-2 text-[#00615F]" />
          ...
          <div className="bg-[#00615F] text-white rounded-lg p-8 my-12 text-center">
            ...
            <a
              href="/merchant/auth"
              className="bg-white text-[#00615F] px-8 py-3 rounded-lg font-medium hover:bg-[#F3EACE] transition-colors inline-block"
            >
              Partner ol
            </a>
          </div>
