...
export default function OffersPage() {
  ...
  const requestGeolocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        const zoom =
          radiusKm <= 5 ? 13 : radiusKm <= 10 ? 12 : radiusKm <= 20 ? 11 : 10;
        setMapZoom(zoom);
        setLoading(false);
      },
      (error) => {
      ...
      try {
        ...
        if (error) {
          ...
          const formattedOffers = data
            ...
            .sort(
              (a: Offer, b: Offer) => a.distance_meters - b.distance_meters
            );
  ...
  const handleRadiusChange = (newRadiusKm: number) => {
    ...
    const zoom =
      newRadiusKm <= 5 ? 13 : newRadiusKm <= 10 ? 12 : newRadiusKm <= 20 ? 11 : 10;
    setMapZoom(zoom);
  };
  ...
  const handleOfferActionClick = () => {
    if (!user) navigate("/customer/auth");
  };
          ...
          <div className="bg-orange-100 border-l-4 border-orange-500 p-4">
            <div className="flex items-center">
              ...
              <p className="text-sm text-orange-800">
                <strong>Impossible d'accéder à votre position.</strong> Affichage
                de la zone de Bourg-en-Bresse par défaut.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="bg-red-100 border-l-4 border-red-500 p-4">
            <div className="flex items-center">
              ...
              <p className="text-sm text-red-800">
                <strong>Erreur de géolocalisation.</strong> Position par défaut
                utilisée.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            {offers.length === 0 ? (
              ...
              <div className="text-sm text-gray-600">
                ...
                offre{offers.length !== 1 ? "s" : ""} trouvée{offers.length !== 1 ? "s" : ""} dans
                un rayon de {radiusKm} km
              </div>
            )}
          </div>
        </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  >
                    ...
                    <span>
                      {user ? "Voir détail" : "Se connecter pour réserver"}
                    </span>
                  </button>
                </div>
              </div>
