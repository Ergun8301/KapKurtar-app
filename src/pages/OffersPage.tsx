    ...
    >
      ...
      <div className={`${isMobile ? "w-24 p-2" : "w-32 p-3"} border-l border-gray-100 flex flex-col items-center justify-center text-center bg-gray-50`}>
        ...
        {viewMode === "nearby" && offer.distance_meters > 0 && (
          <p className={`text-blue-600 font-semibold ${isMobile ? "text-[10px]" : "text-xs"}`}>
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-100px)]">
      <div className="relative flex-1 border-r border-gray-200 h-1/2 md:h-full">
        ...
        {viewMode === "nearby" && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-[900] bg-white rounded-full shadow-lg px-4 py-2.5 flex items-center space-x-3 border-2 border-tilkapp-blue/20">
            <input
              type="range"
              min={1}
              max={30}
              ...
              className="w-32 md:w-36 accent-tilkapp-blue cursor-pointer focus:outline-none"
            />
