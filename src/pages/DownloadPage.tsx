    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#00615F]">4.8★</div>
                <div className="text-sm text-gray-600">App Rating</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#00615F]">50K+</div>
                <div className="text-sm text-gray-600">Downloads</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#00615F]">1M+</div>
          ...
          <div>
            ...
            <div className="space-y-8 mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start space-x-4">
                  <div className="bg-[#F3EACE] p-4 rounded-lg">
                    <feature.icon className="w-8 h-8 text-[#00615F]" />
                  </div>
                  <div>
            ...
            <div className="bg-[#00615F] py-16">
              <h3 className="font-semibold text-[#00615F] mb-2">📱 Activate Notifications</h3>
              <p className="text-[#00615F] leading-relaxed">
          ...
          <div className="flex justify-center relative">
            <div className="mx-auto w-64 h-96 bg-gray-900 rounded-3xl p-2 shadow-2xl">
              <div className="w-full h-full bg-white rounded-2xl overflow-hidden relative">
                ...
                <div className="p-4 space-y-3">
                  <div className="bg-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-2">
                      <div className="w-8 h-8 bg-[#00615F] rounded-full"></div>
                      <div>
                ...
                <div className="absolute top-32 left-2 right-2 bg-white rounded-lg shadow-lg p-3 border-l-4 border-[#00615F]">
                  <div className="flex items-center space-x-2">
                    <Bell className="w-4 h-4 text-[#00615F]" />
                    <div>
        ...
        <div className="text-center mt-16">
          ...
          <a
            href="/"
            className="bg-[#00615F] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#2DD4BF] transition-colors inline-block text-lg"
          >
            Explore Offers Now
          </a>
        </div>
