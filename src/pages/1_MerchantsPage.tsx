  ...
  const testimonials = [
    {
      ...
      quote: 'TILKAPP helped us reduce waste by 60% while attracting amazing new customers. It\'s been a game-changer for our business.',
      rating: 5
    },
    {
      name: 'James Chen',
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="relative h-full flex items-center justify-center">
            <div className="text-center text-white px-4 max-w-4xl">
              ...
              <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                reduce food waste, and boost your bottom line with TILKAPP.
              </p>
        ...
        <div id="benefits" className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Partner with TILKAPP?</h2>
        ...
        <div className="py-24 bg-tilkapp-orange">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-orange-200 mt-6">No setup fees • Cancel anytime • 24/7 support</p>
          </div>
        </div>
      </div>
