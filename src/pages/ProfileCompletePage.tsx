          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <div className="relative inline-block">
                ...
                <label className="absolute bottom-0 right-0 bg-tilkapp-orange text-white p-2 rounded-full cursor-pointer hover:bg-orange-600 transition-colors">
            ...
            <div className="flex justify-between items-center pt-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="bg-tilkapp-orange text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center"
              >
