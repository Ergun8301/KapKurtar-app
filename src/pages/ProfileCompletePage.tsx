          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <div className="relative inline-block">
                ...
                <label className="absolute bottom-0 right-0 bg-tilkapp-blue text-white p-2 rounded-full cursor-pointer hover:bg-blue-700 transition-colors">
            ...
            <div className="flex justify-between items-center pt-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="bg-tilkapp-blue text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center"
              >
