            ...
            >
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <span className="text-[#00615F] font-medium group-hover:text-[#2DD4BF] transition-colors">
                    Mesaj gönder →
                  </span>
                </div>
              </div>
              ...
              {isSubmitted ? (
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="bg-[#00615F] text-white px-6 py-2 rounded-lg hover:bg-[#2DD4BF] transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className="w-full bg-[#00615F] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#2DD4BF] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      'Gönderiliyor...'
                    ) : (
