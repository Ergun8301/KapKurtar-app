        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative">
              ...
              <label
                className={`absolute bottom-0 right-0 bg-tilkapp-blue rounded-full p-2 cursor-pointer hover:bg-blue-700 transition-colors shadow-lg ${
            ...
            {hasChanges && (
              <div className="flex gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="flex-1 px-6 py-3 bg-tilkapp-blue text-white rounded-lg hover:bg-blue-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isSaving ? (
                    <>
