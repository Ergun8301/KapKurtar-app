...
export default function OffersMapPage() {
  ...
  // ✅ Les offres sont maintenant gérées par le hook useOffers (fetch + real-time)
  // Ces useEffect ont été supprimés pour éviter la duplication
  ...
  return (
    <>
      ...
      >
        ...
        <div className="md:hidden absolute bottom-4 left-0 right-0 z-[901] px-3 space-y-1.5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full py-2.5 px-4 pl-11 bg-white rounded-xl shadow-lg text-sm border border-gray-100 focus:ring-2 focus:ring-[#00A690] focus:outline-none focus:border-transparent"
              value={searchAddress}
